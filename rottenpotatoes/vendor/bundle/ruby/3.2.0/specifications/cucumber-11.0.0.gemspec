...
Gem::Specification.new do |s|
  ...
  s.summary = "cucumber-11.0.0".freeze
  ...
  s.add_runtime_dependency(%q<cucumber-ci-environment>.freeze, ["> 9", "< 12"])
  s.add_runtime_dependency(%q<cucumber-core>.freeze, [">= 16.2.0", "< 17"])
  s.add_runtime_dependency(%q<cucumber-cucumber-expressions>.freeze, ["> 17", "< 20"])
  s.add_runtime_dependency(%q<cucumber-html-formatter>.freeze, ["> 21", "< 24"])
  ...
  s.add_runtime_dependency(%q<sys-uname>.freeze, ["~> 1.5"])
  s.add_development_dependency(%q<cucumber-compatibility-kit>.freeze, ["~> 22.0"])
